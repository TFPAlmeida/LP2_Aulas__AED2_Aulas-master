...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("DifferenceYears: " + d1.differenceMonths(d2));
        ...
        System.out.println("Number days of month " + d1.getMonth() + "/" + d1.getYear() + ": " + (Date.daysMonth((short) d1.getMonth(), d1.getYear())));
        System.out.println("Number days of month " + d3.getMonth() + "/" + d3.getYear() + ": " + (Date.daysMonth((short) d3.getMonth(), d3.getYear())));
